...
<head>
    ...
    <title> Insert Home Appliances </title>
</head>
<body>
    ...
    <div class="col-lg-12"><!-- col-lg-12 Begin -->
        ...
        <ol class="breadcrumb"><!-- breadcrumb Begin -->
            ...
            <li class="active"><!-- active Begin -->
                ...
                <i class="fa fa-dashboard"></i> Dashboard / Insert Home Appliances
        ...
        <div class="panel panel-default"><!-- panel panel-default Begin -->
           ...
           <div class="panel-heading"><!-- panel-heading Begin -->
               ...
               <h3 class="panel-title"><!-- panel-title Begin -->
                   ...
                   <i class="fa fa-money fa-fw"></i> Insert Home Appliances
...
if(isset($_POST['submit'])){
    ...
    $cost = $_POST['cost'];
        ...
        $sql = "INSERT INTO home_appliances(service_name, estmate_price) VAlUES('$name', '$cost')";
