...
<head>
    ...
    <title> Insert Packshift Service </title>
</head>
<body>
    ...
    <div class="col-lg-12"><!-- col-lg-12 Begin -->
        ...
        <ol class="breadcrumb"><!-- breadcrumb Begin -->
            ...
            <li class="active"><!-- active Begin -->
                ...
                <i class="fa fa-dashboard"></i> Dashboard / Insert Packshift Service
        ...
        <div class="panel panel-default"><!-- panel panel-default Begin -->
           ...
           <div class="panel-heading"><!-- panel-heading Begin -->
               ...
               <h3 class="panel-title"><!-- panel-title Begin -->
                   ...
                   <i class="fa fa-money fa-fw"></i> Insert Packshift Service
...
if(isset($_POST['submit'])){
    ...
    $cost = $_POST['cost'];
        ...
        $sql = "INSERT INTO packshift_service(service_name, estmate_price) VAlUES('$name', '$cost')";
