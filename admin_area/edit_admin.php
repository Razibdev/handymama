...
<?php 
    ...
    if(isset($_GET['edit_admin'])){
        ...
        $get_p = "select * from admins where admin_id='$edit_admin'";
...
if(isset($_POST['update'])){
    ...
    $admin_type = $_POST['type'];
        ...
        $sql = "UPDATE admins SET admin_name = '$admin_name', admin_email = '$admin_email', admin_password = '$admin_password', type = '$admin_type' WHERE admin_id = '$edit_admin'";
